    ...
    $(".content > a").on("click", function () {
        ...
        switch ($(".content > a").index(this) + 1) {
            ...
            case 26:
                ...
                break;
            case 27:
                sessionStorage.setItem("slideNum", 8);
                break;
            case 28:
                sessionStorage.setItem("slideNum", 10);
                break;
            case 29:
                sessionStorage.setItem("slideNum", 11);
                break;      
            case 30:
                sessionStorage.setItem("slideNum", 16);
                break;
            case 31:
                sessionStorage.setItem("slideNum", 21);
                break;
            case 32:
                sessionStorage.setItem("slideNum", 22);
                break;
            case 33:
                sessionStorage.setItem("slideNum", 26);
                break;
            case 34:
                sessionStorage.setItem("slideNum", 27);
                break;
            default:
                break;
        }
